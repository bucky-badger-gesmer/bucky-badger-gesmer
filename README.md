...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://go-skill-icons.vercel.app/api/icons?i=androidstudio,angular,apollo,apple,aws,azure,babel,bash,bootstrap,bsd,cloudflare,codepen,cs,css,cypress,debian,discord,django,docker,dotnet,express,fastapi,figma,firebase,flask,gcp,git,github,githubactions,gitlab,gradle,grafana,graphql,html,java,jest,js,jenkins,linux,materialui,md,mongodb,netlify,nextjs,nodejs,notion,npm,podman,postgres,postman,powershell,py,raspberrypi,react,redux,regex,remix,selenium,sklearn,sqlite,stackoverflow,styledcomponents,supabase,svg,tailwind,ts,ubuntu,vercel,vite,vscode,webpack,windows" />
  </a>
</p>
